...
videojs.Vhs.xhr.beforeRequest = function (options) {
  if (
    options.uri.indexOf("videoplayback") === -1 &&
    options.uri.indexOf("local=true") === -1
  ) {
...
if (video_data.params.save_player_pos) {
  ...
  if (
    video_data.params.enable_exclude_save_player_pos_for_few_genres &&
    ["Music"].includes(video_data.genre)
  ) {
