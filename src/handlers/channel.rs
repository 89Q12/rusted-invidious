...
pub async fn index(Extension(state): Extension<Arc<State>>,Path(id): Path<String>) -> Response{
    todo!()
}

/// Handler for the path /channel/:id/videos, /c/:id/videos, /user/:id/videos
pub async fn videos(Extension(state): Extension<Arc<State>>,Path(id): Path<String>) -> Response{
    todo!()
}

/// Handler for the path /channel/:id/playlists, /c/:id/playlists, /user/:id/playlists
pub async fn playlists(Extension(state): Extension<Arc<State>>,Path(id): Path<String>) -> Response{
    todo!()
}

/// Handler for the path /channel/:id/community, /c/:id/community, /user/:id/community
pub async fn community(Extension(state): Extension<Arc<State>>,Path(id): Path<String>) -> Response{
    todo!()
}
/// Handler for the path /channel/:id/live, /c/:id/live, /user/:id/live
