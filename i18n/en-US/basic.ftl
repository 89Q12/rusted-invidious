...
alphabetically_reverse= alphabetically - reverse,_reverse
channel_name = channe= name,
channel_name_reverse = reverse: channel name - reverse,
...
Delete_playlist_named= Delete playlist {$playlist_name},
...
Hidden_token_required =Hidden field \token\ is a required field,
...
English= English,
English_auto_generate_uk= English (United Kingdom),
English_auto_generate_us=: English (United States),
