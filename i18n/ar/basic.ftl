live= مُباشِر,
shared_ago= تمَّ رفع المقطع المرئيّ مُنذ,
...
authorize_token_for= السماح بالرمز المميز ل 'x'؟,
yes= نعم,
no= لا,
...
_uploaded_a_video=  رفع فيديو,
_is_live=  في بث مباشر,
...
editing_playlist= تعديل قائمة التشغيل,
...
invidious_private_feed_for= تغذية Invidious خاصة ل 'x',
channel=: قناة:,
...
none= لاشيء,
videoinfo_started_streaming_x_ago= بدأ البث منذ,
...
crash_page_refresh= حاول <a href:\\> تحديث الصفحة </a>,
crash_page_switch_instance= حاول <a href:\\> استخدام مثيل آخر </a>,
...
crash_page_report_issue= إذا لم يساعد أي مما سبق، يرجى فتح <a href:\\> مشكلة جديدة على GitHub </a> (ويفضل أن يكون باللغة الإنجليزية) وتضمين النص التالي في رسالتك (لا تترجم هذا النص):,
crash_page_read_the_faq= قراءة <a href:\\> الأسئلة المتكررة (الأسئلة الشائعة) </a>,
...
crash_page_search_issue= بحثت عن <a href:\\> المشكلات الموجودة على GitHub </a>,
